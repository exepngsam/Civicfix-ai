...
import { Search, PlusCircle, Bell, ArrowLeft, Radio, Terminal } from 'lucide-react';
    ...
    <header className="h-16 border-b border-slate-800/80 bg-slate-950/70 backdrop-blur-xl px-6 flex items-center justify-between sticky top-0 z-20">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-800 text-slate-400 hover:text-white hover:border-slate-700 text-xs font-mono transition-colors"
        >
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-civic-orange to-amber-500 text-slate-950 font-bold text-xs uppercase font-mono tracking-wider shadow-glowOrange hover:scale-105 transition-all duration-200"
        >
